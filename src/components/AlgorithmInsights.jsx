...
function AlgorithmInsights({ selectedAlgorithm, comparisonCount = 0, swapCount = 0, gap = null }) {
  ...
  const gapValue = gap !== null && gap !== undefined ? gap : 'N/A'
  ...
  return (
    <div className="algorithm-insights">
      ...
      <div className="algorithm-insights__content">
        <div className="algorithm-insights__item algorithm-insights__item--single-row">
          ...
          <span className="algorithm-insights__label">Gap:</span>
          <span className="algorithm-insights__value">{gapValue}</span>
        </div>
      </div>
    </div>
  )
